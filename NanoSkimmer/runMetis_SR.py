...
if __name__ == "__main__":
     ...
     samples2016Signal = [
          #2016 Signal MC
          DBSSample(dataset="/TT_FCNC-TtoHJ_aTleptonic_HToWWZZtautau_eta_hut-MadGraph5-pythia8/RunIISummer16NanoAODv7-PUMoriond17_Nano02Apr2020_102X_mcRun2_asymptotic_v8-v1/NANOAODSIM", xsec = "83.88144"),
          DBSSample(dataset="/TT_FCNC-aTtoHJ_Tleptonic_HToWWZZtautau_eta_hut-MadGraph5-pythia8/RunIISummer16NanoAODv7-PUMoriond17_Nano02Apr2020_102X_mcRun2_asymptotic_v8-v1/NANOAODSIM", xsec = "83.88144"),
          DBSSample(dataset="/TT_FCNC-TtoHJ_aTleptonic_HToWWZZtautau_eta_hct-MadGraph5-pythia8/RunIISummer16NanoAODv7-PUMoriond17_Nano02Apr2020_102X_mcRun2_asymptotic_v8-v1/NANOAODSIM", xsec = "83.88144"),
          DBSSample(dataset="/TT_FCNC-aTtoHJ_Tleptonic_HToWWZZtautau_eta_hct-MadGraph5-pythia8/RunIISummer16NanoAODv7-PUMoriond17_Nano02Apr2020_102X_mcRun2_asymptotic_v8-v1/NANOAODSIM", xsec = "83.88144"),
     ]
     ...
     samples2017Signal = [
          #2017 Signal MC
          DBSSample(dataset="/TT_FCNC-TtoHJ_aTleptonic_HToWWZZtautau_eta_hut-MadGraph5-pythia8/RunIIFall17NanoAODv7-PU2017_12Apr2018_Nano02Apr2020_102X_mc2017_realistic_v8-v1/NANOAODSIM", xsec = "83.88144"),
          DBSSample(dataset="/TT_FCNC-aTtoHJ_Tleptonic_HToWWZZtautau_eta_hut-MadGraph5-pythia8/RunIIFall17NanoAODv7-PU2017_12Apr2018_Nano02Apr2020_102X_mc2017_realistic_v8-v1/NANOAODSIM", xsec = "83.88144"),
          DBSSample(dataset="/TT_FCNC-TtoHJ_aTleptonic_HToWWZZtautau_eta_hct-MadGraph5-pythia8/RunIIFall17NanoAODv7-PU2017_12Apr2018_Nano02Apr2020_102X_mc2017_realistic_v8-v1/NANOAODSIM", xsec = "83.88144"),
          DBSSample(dataset="/TT_FCNC-aTtoHJ_Tleptonic_HToWWZZtautau_eta_hct-MadGraph5-pythia8/RunIIFall17NanoAODv7-PU2017_12Apr2018_Nano02Apr2020_102X_mc2017_realistic_v8-v1/NANOAODSIM", xsec = "83.88144"),
     ...
     samples2018Signal = [
          #2018 Signal MC
          DBSSample(dataset="/TT_FCNC-TtoHJ_aTleptonic_HToWWZZtautau_eta_hut_TuneCP5-MadGraph5-pythia8/RunIIAutumn18NanoAODv7-Nano02Apr2020_tauDecays_102X_upgrade2018_realistic_v21-v1/NANOAODSIM", xsec = "83.88144"),
          DBSSample(dataset="/TT_FCNC-aTtoHJ_Tleptonic_HToWWZZtautau_eta_hut_TuneCP5-MadGraph5-pythia8/RunIIAutumn18NanoAODv7-Nano02Apr2020_tauDecays_102X_upgrade2018_realistic_v21-v1/NANOAODSIM", xsec = "83.88144"),
          DBSSample(dataset="/TT_FCNC-TtoHJ_aTleptonic_HToWWZZtautau_eta_hct_TuneCP5-MadGraph5-pythia8/RunIIAutumn18NanoAODv7-Nano02Apr2020_tauDecays_102X_upgrade2018_realistic_v21-v1/NANOAODSIM", xsec = "83.88144"),
          DBSSample(dataset="/TT_FCNC-aTtoHJ_Tleptonic_HToWWZZtautau_eta_hct_TuneCP5-MadGraph5-pythia8/RunIIAutumn18NanoAODv7-Nano02Apr2020_tauDecays_102X_upgrade2018_realistic_v21-v1/NANOAODSIM", xsec = "83.88144"),
     ]
     ...
     if all_mc:
          samples = samples2016BG + samples2017BG + samples2018BG + samples2016Signal + samples2017Signal + samples2018Signal
     if all_data:
          samples = samples2016Data + samples2017Data + samples2018Data
     if all_mc_data:
          samples = samples2016BG + samples2016Signal + samples2016Data + samples2017BG + samples2017Signal + samples2017Data + samples2018BG + samples2018BG + samples2018Signal + samples2018Data 
     ...
     for i in range(100):
          ...
          StatsParser(data=total_summary, webdir="~/public_html/dump/metis_FCNCBabies/").do()
          # power nap
          time.sleep(60.*60)
